...
<h1  align="center" style=" color:#003C71;font-size:40px; font-family:Clear Sans, sans-serif; " >Demos Fair</h1>

      <form   accept-charset="UTF-8" method="post" action="judmentPage.php">
